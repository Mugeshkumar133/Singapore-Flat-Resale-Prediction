...
data = pd.read_csv('C:/Users/muges/Downloads/data_mart.csv')
...
if selected == "Predictions":
    ...
    st.markdown("### :orange[Predicting Resale Price (Regression Task) (Accuracy: 77%)]")
    ...
    try:
        with st.form("form1"):
            ...
            if submit_button is not None:
                with open(r"C:/Users/muges/Downloads/model (3).pkl", 'rb') as file:
                    loaded_model = pickle.load(file)
                with open(r'C:/Users/muges/Downloads/scaler (3).pkl', 'rb') as f:
